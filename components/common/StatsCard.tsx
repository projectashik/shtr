  ...
  return (
    <div className="dark:border-dark102 dark:bg-dark102 flex items-center rounded border bg-white p-2 shadow dark:shadow-gray-800 md:p-6  ">
      ...
      <div className="ml-4 flex flex-col">
        <h2 className="text-md from-primary-600 dark:from-primary-500 bg-gradient-to-r to-rose-600 bg-clip-text  font-semibold leading-none text-transparent dark:to-rose-500 md:text-xl">
          {title}
        </h2>
